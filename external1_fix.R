...
# We set a data table with the simulated data
  ...
  DATASIM[, health_bar:= (health_1996 + health_1998 + health_2000 + health_2002 + health_2004 + health_2006)/(1+alive_1996 + alive_1998 + alive_2000 + alive_2002 + alive_2004 +alive_2006)]
